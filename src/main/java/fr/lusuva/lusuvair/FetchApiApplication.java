...
/**
 * The FetchApiApplication class fetches air quality data from the WAQI API.
 * It stores relevant particle information in a database.
 */
...
public class FetchApiApplication implements CommandLineRunner {
    ...
    /**
     * Adds particle data to the given map if the particle data is not null and has
     * a non-zero value.
     *
