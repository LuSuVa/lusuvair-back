...
public class FetchApiApplication implements CommandLineRunner {
    ...
    /**
     * This method is executed after the application context is loaded and 
     * right before the Spring Boot application starts.
     *
    ...
    public void run(String... args) throws Exception {
        ...
        WaqiDataDto waqiData = template.getForObject(
                "http://api.waqi.info/feed/rennes/?token=01eb30b0ce9ad323162d0394e6b3446231f203cf", WaqiDataDto.class);
    ...
    /**
     * Adds a particles data and persists it to the database
     * if the particle data is not null and has a non-zero value.
     *
    ...
    private void addParticleToMap(Map<String, Double> particles, String key, ParticleDto particleDto) {
        if (particleDto != null && particleDto.getV() != 0) {
            ...
            particleService.insertParticle(particleEntity);
        }
    }
}
